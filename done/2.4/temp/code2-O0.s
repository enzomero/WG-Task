 ...
 # -auxbase-strip code2-O0.s -O0 -Wall -fverbose-asm -fdump-tree-all
...
func:
	...
	movl	(%rax), %edx	 # x, D.2585
	movl	-4(%rbp), %eax	 # y, tmp92
	addl	%edx, %eax	 # D.2585, tmp91
	movl	%eax, -8(%rbp)	 # tmp91, r
	movl	-8(%rbp), %eax	 # r, tmp93
	movl	%eax, %edx	 # tmp93,
	leaq	.LC0(%rip), %rcx	 #,
	call	printf	 #
	nop
